...
export default function Catogories() {
  return (
    <Flex flexWrap={'wrap'} gap={5} maxW={{'2xl': '80%', md: '95%', base: '100%'}} mx={'auto'} my={'5vh'} >
        <Box width={{md: '300px', base: '100%'}}  bgGradient='linear(to-r, gray.800, pink.800)' color={'white'} mx={{md: 0, base: 2}} rounded={'md'} py={6} px={3}>
